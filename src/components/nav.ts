...
import { BarChart3, List, Package, Settings, Store, type LucideIcon } from 'lucide-react';
...
export const NAV_ITEMS: readonly NavItem[] = [
  // ホームは豆のコレクション（棚）。一覧は /logs（2026-09-24）
  { href: '/', label: '豆のコレクション', short: 'ホーム', icon: Package },
  { href: '/logs', label: '入力記録一覧', short: '一覧', icon: List },
