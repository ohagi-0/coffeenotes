...
export const LOG_SELECT =
  '*, bean:beans!inner(id, name, country, process, variety, roaster_id, price_jpy, roaster:roasters(id, name), bean_images(side, storage_path)), shop:shops(id, name, kind), roast:roasts(id, roasted_on, roast_level), log_tags(tag:tags(id, name))';
