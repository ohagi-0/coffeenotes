...
- [ ] Phase 1: UI（Issues #9〜#24）。完了: #9〜#14 #16〜#19 #22 #24、#23 は段階 1（ナビ）まで。#15 部品ページ（/dev/components）と #21 記録したお店も完了。残り: #20 詳細の部品とルート（/beans?id= と /logs?id=、B 担当）、#23 段階 2（xl の一覧 + 詳細、#20 の後）。進捗と分担は `docs/worklog/ui-progress.md`（2026-09-22）
